...
typedef enum {INICIO, MENSAGEM, SENHA1, SENHA2, SENHA3, SENHA4, SENHA_ERRADA, LEITURAS1, LEITURAS2,
...
CONF_POT_INF, CONF_POT_SUP, ESTADO_ALARME_POT, POT_Desliga, POT_Liga, Freq_Alarme, MENU,LDR_FINALIZADO, POT_FINALIZADO, DATA_FINALIZADO, LED_FINALIZADO, FREQ_FINALIZADO}Estados_enum;
